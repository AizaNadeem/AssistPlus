...
public class AssistTextEntry {
	String		textID, classID, attrID, assistText, fontcolor, background,workflowID,workflowStatusId;
	boolean		isDiffColor;
	String[]	roles;
	...
	public boolean getsetWorkflowID() {
		return isDiffColor;
	}

	public boolean getWorkflowStatusID() {
		return isDiffColor;
	}
