...
var assistMessage=
	"<div class='subcontent' id='assistMessage'>" +
		...
		"<div class='box'>" +
			...
			"</form></div>" +
		"</div>"+
		"<span class='label'>Enable User Acknowledgment:</span>" +
		"</div>"+
	...
	/*"<div class='box-container'>" +
		...
		"</div>"+
		"<span class='label'>Notification Box Color:</span>" +
	"</div>"+
...
return html;
	...
	function classesNotifContainerHTML(rolesHtml)
	{
		...
		"<div class='rightMain'>" +
			"<div class='subcontent' id='assistClassMessage'>" +
			...
			"<div class='boxClass'>" +
				...
				"</form></div>" +
			"</div>"+
			"<span class='label'>Enable Assist Message Bar:</span>" +
			"</div>"+
