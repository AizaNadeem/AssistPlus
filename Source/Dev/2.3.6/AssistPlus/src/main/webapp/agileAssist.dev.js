...
function popupDiv(notifMsg, enableAck, popup) {
	let div = "<div id=" +popup+ " class='popup-container'>"+
			...
			if(enableAck=="Yes")
				div = div + "<button id='accept-button' class='popup-button'>Accept</button>";
...
function buttonsDiv(enableAck){
	...
	if(enableAck=="Yes")
    	buttons = buttons + "<button id='acknowledgeAssistMessage' class='acknowledge-assist'>Accept</button>";
	return buttons;
}
