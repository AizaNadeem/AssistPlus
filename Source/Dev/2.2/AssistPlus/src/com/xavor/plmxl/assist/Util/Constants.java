...
public final class Constants {
	...
	public static class DB {
		...
		public static Map<String,String> 	CONFIG_MAP					=new HashMap<String, String>(){{put("hoverColor","#d5e2e6");put("fontColor","#433900");put("backgroundColor","#eeece1");put("textDuration","3");put("indicateNewText","No");}};
