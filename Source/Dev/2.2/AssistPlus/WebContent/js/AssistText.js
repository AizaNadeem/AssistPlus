...
PLMFlex.Assist.AssistText = (function() {
	...
	function enableRichText($this) {
		...
		$this.find('textarea').tinymce({
			...
			paste_retain_style_properties : "border, border-left, border-right, border-bottom, border-top, color, font-size, font-weight",
			...
			theme_advanced_buttons2 : "cut,copy,pastetext,pasteword,|,search,replace,|,|,undo,redo,|,link,unlink,anchor,image,help,code,|,insertdate,inserttime,preview,|,",
