	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (mode.equalsIgnoreCase("new")) {
				...
				try {
					dbh = new DBHandler();
					//textID = dbh.addNewAssistText(classId, attrId,workflowID,workflowStatusID);
			 ...
			 if (mode.equalsIgnoreCase("save")) {
				...
				try {
					...
					{					
						...
						try {
							dbh = new DBHandler();
							int intTextId = dbh.addNewAssistText(classId, attrId, assistText, fontColor, backgroundColor, isDiffColor,workflowID,workflowStatusID);
							textId=Integer.toString(intTextId);
							dbh.updateTextRoleList(textId, roles);//roles = dbh.getRoleOptions();
					...
					////////////////////////////////new row handling end///////////////////////
						...
						dbh = new DBHandler();
						dbh.updateAssistText(textId, assistText, fontColor, backgroundColor, isDiffColor,workflowID,workflowStatusID);
