...
public class AssistPlus extends HttpServlet {
			...
			if (ActHandler.isLicValid()) {
				if (!classId.equals("undefined")) {
					...
					if (murl != null && !murl.equals("")) {
						...
						if (!isOptedOut) {
							String loadAssistForAffectedItem = request.getParameter("loadAssistForAffectedItem").toString().trim();
							String loadAssistForMainObject = request.getParameter("loadAssistForMainObject").toString().trim();
							...
							String affectedItem = request.getParameter("affectedItem").toString().trim();
	...
	private JSONObject loadAssistMapping(IAgileSession session, DBHandler dbh, String rolesList, boolean isAffectedItem, String classId, String objID, String lifecycleID, String workflowID, String workflowStatusID) throws Exception {
		JSONObject jobj = new JSONObject();
