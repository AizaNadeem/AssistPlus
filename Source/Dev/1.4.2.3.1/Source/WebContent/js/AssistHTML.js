...
"</div>"+
	...
	"<label class='star-text'> *To designate a different Master node, select Slave for current AssistPlus node.</label>" +
	"<button class='button saveConfig' id='saveConfig'>Save Configuration</button>" +
...
"<div class='subcontent' id='changePassword'>"+
	...
	"<span class='button pwdchange'>Change Password</span>"+
"</div>";
		...
		"<div class='subcontent' id='import-export'>"+
			...
			"<div id='exportBox' class='box-container' >"+
				"<form name='exportForm' action='DownloadXML' method='post'>"+
					"<span class='button exportDB' >Export</span>"+
			...
			"<span  class='button importDB'>Import</span>"+
	"</div>";
...
"<div class='settingsFilter'>" +
	"<div class='filter'>" +			
		...
		"<a id='labelSelectAll' >Select All</a>"+
		"<span class='pointer' id='selectAll' ></span>"+
	"</div>" +
	"<div class='filter'>" +
		"<a id='labelRemoveAll' >Unselect All</a>"+
		"<span class='pointer' id='removeAll' ></span>"+
			...
			"<div class='rightMain'>" +
				...
				"<div class='rightBottom'>" +
					"<div id='text-div'>"+
						...
						"<thead>"+
							"<tr>" +
								"<th class='tableWorkflow'>Workflows</th>"+
