...
PLMFlex.Assist.AssistText=(function(){
	...
	function loadAttributes(classId, classLevel,$this) 
	{
		...
		$AttContainer.append('<div style="height:200px;display:table;"><img src="img/loading1.gif" id="waiting" style="margin-left:360px; margin-top:60px;background-color:white;vertical-align:middle;"</div> ');
