...
jQuery.fn.colourPicker = function (conf) {
	...
	return this.each(function () {
		...
		var input	= jQuery("<span name='" + select.attr('name') + "' style='background-color:" +config.bgcolor+";color:"+config.fontcolor+" ;min-width:70px' attr-data='" + select.val() + "'>"+(config.fontcolor=='#666' ? "Set Default":config.isBG==true?"Background Color":"Text Color")+"</span>").insertAfter(select);
		var loc		= '';
