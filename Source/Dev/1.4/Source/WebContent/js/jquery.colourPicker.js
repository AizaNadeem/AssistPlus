...
jQuery.fn.colourPicker = function (conf) {
	...
	return this.each(function () {
		...
		var input	= jQuery("<span name='" + select.attr('name') + "' style='background-color:" +config.bgcolor+";color:"+config.fontcolor+"' attr-data='" + select.val() + "'>Text Color</span>").insertAfter(select);
		var loc		= '';
