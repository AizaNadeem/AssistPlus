...
public final class Constants {
	...
	public static class XML {
		...
		public static String TableAssistNotification = "AssistNotification";
		public static String TableAssistConfiguration = "AssistConfiguration";
		public static String TableAssistClassNotification = "ClassNotification";
	...
	public static class Excel {
		...
		public static String MessageHeader = "Assist Notification";
		public static String ClassMessageHeader = "Assist Class Notification";
		public static String NotifEnableHeader = "Enable Notification";
		public static String OptOutEnableHeader = "Enable Opt-Out";
		public static String OverrideEnableHeader = "Enable Override";
		public static String DurationEnableHeader = "Enable Duration";
		public static String DurationLimitHeader = "Duration Days";
		public static String FontColorHeader = "Font Color";
		public static String BackgroundColorHeader = "Background Color";
