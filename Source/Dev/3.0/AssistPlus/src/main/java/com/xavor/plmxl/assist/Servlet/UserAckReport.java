...
public class UserAckReport extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		log.debug("Entering UserAckReport: doPost...");
		String jsonResponse = "";
		
		try {
			DBHandler dbh = new DBHandler();
			Map<String, List<JSONObject>> report = (Map<String, List<JSONObject>>) dbh.handleDBRequest("generateUserAckReport", null, false);
		...
		log.debug("Exiting UserAckReport: doPost...");
	}
