...
var assistMessage=
	"<div class='subcontent' id='assistMessage'>" +
		"<div class='box-container' id='enableNotification'>"+
		"<div class='box'>" +
			"<div class='radio-box'>" +
			"<form>"+
				"<label class='radio-label'>"+
					"<input class='radio-field' type='radio' value='Yes' id='enableNotification-Yes' name='enableNotification'/>Yes"+
				"</label>"+
				"<label class='radio-label'>"+
					"<input class='radio-field' type='radio' value='No' id='enableNotification-No' name='enableNotification'/>No"+
				"</label>"+
			"</form></div>" +
		"</div>"+
		"<span class='label'>Enable Assist Notification Bar:</span>" +
		"</div>"+
		"<div class='box-container' id='enableAck'>"+
		"<div class='box'>" +
			"<div class='radio-box'><form>"+
				"<label class='radio-label'>"+
					"<input class='radio-field' type='radio' value='Yes' id='enableAck-Yes' name='enableAck'/>Yes"+
				"</label>"+
				"<label class='radio-label'>"+
					"<input class='radio-field' type='radio' value='No' id='enableAck-No' name='enableAck'/>No"+
				"</label>"+
			"</form></div>" +
		"</div>"+
		"<span class='label'>Enable User Opt-Out:</span>" +
		"</div>"+
		"<div class='box-container' id='enableNotifDuration'>"+
			"<div class='box'>" +
				"<div class='radio-box'><form>"+
					"<label class='radio-label'  >"+
						"<input class='radio-field'  type='radio' value='Yes' id='enableDuration'  name='enableDuration'/>Yes"+
					"</label>"+
					"<label class='radio-label' >"+
						"<input class='radio-field'  type='radio' value='No' id='disableDuration' name='enableDuration' />No"+
					"</label>"+
				"</form></div>" +
			"</div>"+
			"<span class='label'>Enable Notification Duration:</span>" +
		"</div>"+
		"<div class='box-container' id='durationBox'>"+
			"<div class='box'>" +
				"<div class='radio-box'><form>"+
				...
				"</form></div>" +
			"</div>"+
			"<span class='label'>Notification Duration (Days):</span>" +
		"</div>"+
		"<div class='box-container'>" +
		"<div class='hoverbox' >"+
			"<span id='notificationBackgroundColor'  ></span>" +
		"</div>"+
		"<span class='label'>Notification Bar Color:</span>" +
		"</div>"+
		"<div id='roles-notif-div'>"+
			"<form onkeydown='return event.key !== 'Enter';'>"+
				"<div id='dialog-notif-roles'></div>"+
			"</form>"+
		"<span class='label' id='editTextRoleLabel'>Roles:</label>"+
		"</div>"+
		"<div class='subcontentleft'>" +
			"<div class='clear'></div>"+
			"<p id='mce_editor'>"+
				"<textarea id='AssistMessage'></textarea>"+
			"</p>"+
		"</div>"+
	
	"<button class='button saveNotification buttonStyle' id='saveNotification'>Save</button>" +
...
var xlsxImportHTML = 
	"<div class='subcontent' id='import-export'>" +
		...
		"<div id='exportBox' class='box-container' >"+
			"<button class='button b-export-xlsx buttonStyle' >Export</button>"+
			"<form name='exportForm' action='DownloadXLSX' method='post'>"+					
				"<p id='download' >Database Exported. <a id='link'>Click here</a> to Download!</p>"+
				"<input type='submit' id='exportExcel'>"+
			"</form>"+
		"</div>"+
		...
		"<div class='box-container'>" +
			"<div class='box' id='lowerBox'>" +
				"<div id='radio' class='radio-box'>" +
				"<label class='radio-left-label' >"+
					"<input type='radio' class='radio-left' name='importType' value='overwrite' />Overwrite" +
					"</label>"+
					"<label class='radio-right-import'  >"+
...
"<div class='subcontent'>" +
	"<div style='padding-left: 25px' >" +
		"<span class='label' style='float:left; padding-right:25px;'>Find what:</span>" +
		"<span class='field' style='float:left;padding-right: 15px;'><input class='text' type='search' value='' id='searchText'/></span>" +
	"</div>"+
	"<button class='button buttonStyle' style='float:left;' id='searchAssistText'>Find</button><br><br><br>"+
	
	"<div id='replace-box' style='padding-left: 25px'>" +
		"<span class='label' style='float:left;'>Replace with:</span>" +
		"<span class='field' style='float:left;padding-right: 15px;'><input class='text' type='search' value='' id='replaceText'/></span>" +	
	"</div>"+
	
	"<button class='button buttonStyle' style='float:left;' id='replaceAssistText'>Replace All</button>"+
	
	"<div style='width: 95%; height: 550px; padding-top: 40px; padding-left:25px;>" +
	"	<div id='report-grid-wrapper'><div id='report-grid'></div></div>"+
	"</div>" +
	
	"<div id='dialog-form' title='Create new entry'>"+
	"<span class='label' style='display: inline-block;'>Enter Text to replace assist Text:</span>" +
	"<span class='field' style='display: inline-block;padding: 11px; '><input class='text' type='search' value='' id='replaceTextDilog'/></span>" +
	"</div>"+
...
return html;
	...
	function classesNotifContainerHTML(rolesHtml)
	{
		var html=
		"<div class='settingsFilter'>" +
		 	"<div class='textFilter classWidth'>"+
		...
		"<div class='rightMain'>" +
			"<div class='subcontentClass' id='assistClassMessage'>" +
			"<div class='box-container' id='enableClassNotification'>"+
			"<div class='boxClass'>" +
				"<div class='radio-box'>" +
				"<form>"+
					"<label class='radio-label'>"+
						"<input class='radio-field' type='radio' value='Yes' id='enableClassNotification-Yes' name='enableClassNotification'/>Yes"+
					"</label>"+
					"<label class='radio-label'>"+
						"<input class='radio-field' type='radio' value='No' id='enableClassNotification-No' name='enableClassNotification'/>No"+
					"</label>"+
				"</form></div>" +
			"</div>"+
			"<span class='label'>Enable Class Notification:</span>" +
			"</div>"+
			"<div class='box-container' id='enableNotificationOverride'>"+
			"<div class='boxClass'>" +
				"<div class='radio-box'>" +
				"<form>"+
					"<label class='radio-label'>"+
						"<input class='radio-field' type='radio' value='Yes' id='enableNotificationOverride-Yes' name='enableNotificationOverride'/>Yes"+
					"</label>"+
					"<label class='radio-label'>"+
						"<input class='radio-field' type='radio' value='No' id='enableNotificationOverride-No' name='enableNotificationOverride'/>No"+
					"</label>"+
				"</form></div>" +
			"</div>"+
			"<span class='label'>Enable Notification Overriding:</span>" +
			"</div>"+
			"<div class='box-container'>" +
			"<div class='hoverClassbox' >"+
				"<span id='notificationClassBackgroundColor'  ></span>" +
			"</div>"+
			"<span class='label'>Message Bar Color:</span>" +
			"</div>"+
			"<div id='roles-notif-div'>"+
				"<form onkeydown='return event.key !== 'Enter';'>"+
					"<div id='dialog-notif-class-roles'></div>"+
				"</form>"+
				"<span class='label' id='editTextRoleLabel'>Roles:</label>"+
			"</div>"+
			"<div class='subcontentClassleft'>" +
				"<div class='clearRight'></div>"+
				"<p id='mce_editor'>"+
					"<textarea id='AssistClassMessage'></textarea>"+
				"</p>"+
			"</div>"+
			"<button class='button saveNotification buttonStyle' id='saveClassNotification'>Save</button>" +
			"</div>"+
		"</div>";
	...
	var ClassesNotifHTML=
	{
		classesNotifHTML:classesNotifContainerHTML
	};
	...
	return{
		...
		ClassesNotifHTML:ClassesNotifHTML,
