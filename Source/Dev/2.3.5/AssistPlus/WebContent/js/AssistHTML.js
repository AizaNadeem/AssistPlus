...
var assistMessage=
	...
	"<div class='box-container'>" +
	"<span class='field'><textarea  rows='3' cols='53' placeholder='assist messge' class='text' maxlength='512' value='' style='float: left;width:inherit;' id='AssistMessage'/></span>" +
	"<span class='label'>Assist Message:</span>" +
"</div>"
	+
