...
(function() {
	var homeDirectory="http://agile934.xavor.com:8090/AssistPlus/";
...
function optOutToggle(userid,classid) {
	...
	var arg = {};
	arg.url="http://agile934.xavor.com:8090/AssistPlus//OptOut";
	jQuery.post(arg.url, {
		userid:userid,
		mode:mode,
		rnd:Math.random()},
...
function getAssistText(classid) {
	...
	var arg = {};
	arg.url="http://agile934.xavor.com:8090/AssistPlus//GetAssistText";
